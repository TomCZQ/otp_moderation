...
class SpreadRateLimiter extends limiter_1.RateLimiter {
...
class RegionRateLimiter {
    constructor(generalRegion, axiosInstance, config) {
        ...
        this.queue = new p_queue_1.default({ concurrency: (_a = config.concurrency) !== null && _a !== void 0 ? _a : Infinity });
    }
...
class RiotRateLimiter {
    constructor(axiosInstance, config) {
        ...
        ;
        [...Object.values(enums_1.Region), ...Object.values(enums_1.Platform)].forEach((generalRegion) => {
